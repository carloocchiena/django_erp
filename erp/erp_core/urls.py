...
urlpatterns = [
    ...
    path('invoice_clone/<int:pk>/', login_required(views.InvoiceClone.as_view()), name='invoice_clone'),
    ...
    path('payment_clone/<int:pk>/', login_required(views.PaymentClone.as_view()), name='payment_clone'),
